...
import { getUsers, getUserById, updateUser, getUserByIdForPanel, updateUserForPanel, getUsersForPanel } from '../controller/user.controller.js'
...
userRoutes.get('/panel', getUsersForPanel);
